...
public class QueryProcess{
	...
	public HashMap<Integer,HashMap<String, String>> executeQuery(ResultSet sqlResult, String luceneParams) throws SQLException, CorruptIndexException, IOException {
	...
	private void joinQuery() throws SQLException, CorruptIndexException, IOException {
		...
		this.resultHashMap = new HashMap<Integer,HashMap<String, String>>();
		...
		while(this.getSqlResult().next() && foundDocuments < this.getSearcher().getDocsIterator().length) {
			while((actualScoreDoc = this.getSearcher().nextIterator()) != null) {
				...
				if (this.getSqlResult().getInt(1) == fileName) {
					...
					this.resultHashMap.put(id, sitesInformations); 
	...
	private HashMap<Integer, HashMap<String, String>> getResultHashMap() {
		return resultHashMap;
	}

	private void setResultHashMap(HashMap<Integer, HashMap<String, String>> resultHashMap) {
